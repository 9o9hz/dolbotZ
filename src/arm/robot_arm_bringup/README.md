...
|---|---:|
| 제어 ON/OFF | 9 |
| SEMIAUTO/MANUAL 전환 | axis 7 양수(십자키 위) |
| 보호 정지 | 비활성(버튼 10은 drive 전용) |

현재 Manual100 축은 shoulder index 3, elbow index 4, wrist index 6(십자키 좌·우)입니다. 실제 매핑은 다음 명령으로 먼저 확인합니다.
